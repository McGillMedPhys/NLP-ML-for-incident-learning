...
#---------------- Data vectorization ---------------#
combined = pandas.read_csv('2_Preprocessed_data.csv', delimiter=',', encoding='latin-1').fillna('')  
...
ps_tfidf.to_csv('3_PS_TFIDF.csv', encoding='utf-8', index=False, quoting=csv.QUOTE_NONNUMERIC)

ps_ohe = return_one_hot(only_ps['Process Step'])
ps_ohe.to_csv('3_PS_OHE.csv', encoding='utf-8', index=False, quoting=csv.QUOTE_NONNUMERIC)

## Problem type
only_pt = combined[combined['Problem Type']!='']
pt_tfidf = return_tfidf_matrix(only_pt['Processed text'], 2500, 3, (1,3))
pt_tfidf.to_csv('3_PT_TFIDF.csv', encoding='utf-8', index=False, quoting=csv.QUOTE_NONNUMERIC)

pt_ohe = return_one_hot(only_pt['Problem Type'])
pt_ohe.to_csv('3_PT_OHE.csv', encoding='utf-8', index=False, quoting=csv.QUOTE_NONNUMERIC)
...
cf_tfidf.to_csv('3_CF_TFIDF.csv', encoding='utf-8', index=False, quoting=csv.QUOTE_NONNUMERIC)
...
cf_ohe.to_csv('3_CF_OHE.csv', encoding='utf-8', index=False, quoting=csv.QUOTE_NONNUMERIC)
